function [delta, DE, de]  = MDEA(Data, Stripesize, Rule, ST, EN, PLOT)
% function [delta, res, Diff, DE, de]  = MDEA(Data, Stripesize, Rule, ST, EN, PLOT)
